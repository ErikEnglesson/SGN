# Copied from: https://raw.githubusercontent.com/keras-team/keras/v2.13.1/keras/applications/inception_resnet_v2.py
# Modifications to batch norm is made to match PyTorch implementation of the network, see line 49.
...
# To match PyTorch's implementation of the architecture, we change the
# momentum and turn on learning of the scale.
BN_MOMENTUM = 0.9 # TensorFlow: 0.99, PyTorch: 0.9
BN_LEARN_SCALE = True # TensorFlow: False, PyTorch: True
...
def conv2d_bn(
    ...
    if not use_bias:
        ...
        x = layers.BatchNormalization(axis=bn_axis, scale=BN_LEARN_SCALE, momentum=BN_MOMENTUM, name=bn_name)(
            x
        )
