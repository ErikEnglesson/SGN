...
flags.DEFINE_enum('corruption_type', 'asym',
                  enum_values=['sym', 'asym', 'aggre', 'worst', 'rand1', 'rand2', 'rand3', 'c100noise', 'instance'],
                  help='Type of label noise.')



# Flags for loss
flags.DEFINE_float('q', 0.7, 'The q hyperparameter in GCE.')
  ...
  def train_step(iterator):
    ...
    def step_fn(inputs):
      ...
      with tf.GradientTape() as tape:
        ...
        gce = (1.0 - tf.math.pow(tf.reduce_sum(one_hot_labels * probs, axis=1), FLAGS.q)) / FLAGS.q
        gce = tf.reduce_mean(gce)
